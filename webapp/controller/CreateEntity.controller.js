sap.ui.define([
	...
	return BaseController.extend("ru.teamidea.odatapractice.WebShop.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Products", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Products", oData);
