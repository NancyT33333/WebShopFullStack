...
sap.ui.define([
	...
	"sap/m/MessageBox",
	"ru/teamidea/odatapractice/WebShop/model/grouper",
	"ru/teamidea/odatapractice/WebShop/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("ru.teamidea.odatapractice.WebShop.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("ru.teamidea.odatapractice.WebShop.view.ViewSettingsDialog", this);
